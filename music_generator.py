...
def generate_music(duration_model: Sequential, notes_model: Sequential, seed_song, song_length, savefile):
    ...
    for notes, duration in zip(song_notes, song_durations):
        notes_in_chord = np.array(notes).nonzero()
        chord_notes = []
...
if __name__ == "__main__":
    ...
    while option < 2:
        ...
        notes_model_file = 'models/notes/note-model-50-0.0074.hdf5' # user_input.get_user_filename('Path to notes model', '.hdf5')
        ...
        # generate music
        generate_music(duration_model, notes_model, seed_song, length)
    option = user_input.get_user_options('What would you like to do', ['Generate music', 'Exit'])
